...
insert into wreckfest2.track_variations (track_id, name, slug) select id, 'Demolition arena', 'demolition-arena' from wreckfest2.tracks where slug = 'scrapyard' on conflict (track_id, slug) do update set name = excluded.name;
